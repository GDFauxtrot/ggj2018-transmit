...
public class Chat_Controller : MonoBehaviour
{
    ...
    /*
      ...
      7  Boss spawning
     */
    private CommandData[] commands = new CommandData[] { new CommandData("!SpawnRaptors", "spawnraptor"), new CommandData("!HealPlayer", "heal"), new CommandData("!PlayerSpeedUp", "playerfast"),
